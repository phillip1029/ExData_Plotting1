...
plot(df$DateTime, df$Sub_metering_1, xlab = "", ylab = "Global_active_power(kilowatts)", col = "black", type = "l")
lines(df$DateTime, df$Sub_metering_2, xlab = "", ylab = "Global_active_power(kilowatts)", col = "red")
lines(df$DateTime, df$Sub_metering_3, xlab = "", ylab = "Global_active_power(kilowatts)", col = "blue", type = "l")
